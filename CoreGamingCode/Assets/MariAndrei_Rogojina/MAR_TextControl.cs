...
public class MAR_TextControl : MonoBehaviour
{
    ...
    void Update()
    {
        if (enableColorTransition && m_TextMeshPro != null)
        {
            ...
            m_TextMeshPro.color = Color.Lerp(startColor, endColor, t); //I have learnt about color lerp through a few tutorials, it's what I use to smoothly transition colors 
        }
    }
